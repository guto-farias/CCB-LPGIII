  ...
  return (
    <View style={styles.conteiner}>
      ...
      <View style={styles.category}>
          ...
          <TouchableOpacity><Text style={[styles.categoryText, { fontWeight: "700" }]}><Link href="/friday">Sexta Feira</Link></Text></TouchableOpacity>
      </View>
      ...
      <ScrollView style={styles.menuContent} showsVerticalScrollIndicator={false}>
        <View style={styles.menuItem}>
          ...
          <View style={styles.groupDescription}>
              ...
              <Text style={styles.menuDescription}>Alface com cenoura</Text>
          </View>

          <View style={styles.groupDescription}>
              <Image style={styles.triangleImg} source={require("../assets/images/triangle.png")}></Image>
              <Text style={styles.menuDescription}>Abobrinha colorida</Text>
          </View>
        </View>
        ...
        <View style={styles.menuItem}>
          ...
          <View style={styles.groupDescription}>
              <Image style={styles.triangleImg} source={require("../assets/images/triangle.png")}></Image>
              <Text style={styles.menuDescription}>Aipim à tomatelli</Text>
          </View>
        </View>
        ...
        <View style={styles.menuItem}>
          ...
          <View style={styles.groupDescription}>
              <Image style={styles.triangleImg} source={require("../assets/images/triangle.png")}></Image>
              <Text style={styles.menuDescription}>Omelete de forno</Text>
          </View>
        </View>
        ...
        <View style={styles.menuItem}>
          ...
          <View style={styles.groupDescription}>
              <Image style={styles.triangleImg} source={require("../assets/images/triangle.png")}></Image>
              <Text style={styles.menuDescription}>Bisteca acebolada</Text>
          </View>
        </View>
      </ScrollView>
