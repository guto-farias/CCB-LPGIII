  ...
  return (
    <View style={styles.conteiner}>
      ...
      <View style={styles.category}>
          ...
          <TouchableOpacity><Text style={[styles.categoryText, { fontWeight: "700" }]}><Link href="/tuesday">Terça Feira</Link></Text></TouchableOpacity>
      ...
      <ScrollView style={styles.menuContent} showsVerticalScrollIndicator={false}>
        <View style={styles.menuItem}>
          ...
          <View style={styles.groupDescription}>
              ...
              <Text style={styles.menuDescription}>Almeirão com cenoura</Text>
          </View>

          <View style={styles.groupDescription}>
              <Image style={styles.triangleImg} source={require("../assets/images/triangle.png")}></Image>
              <Text style={styles.menuDescription}>Beterraba cozido & Fruta</Text>
          </View>
        </View>
        ...
        <View style={styles.menuItem}>
          ...
          <View style={styles.groupDescription}>
              <Image style={styles.triangleImg} source={require("../assets/images/triangle.png")}></Image>
              <Text style={styles.menuDescription}>Batata rústica</Text>
          </View>
        </View>
        ...
        <View style={styles.menuItem}>
          ...
          <View style={styles.groupDescription}>
              <Image style={styles.triangleImg} source={require("../assets/images/triangle.png")}></Image>
              <Text style={styles.menuDescription}>Strogonoff vegetariano</Text>
          </View>
        </View>
        ...
        <View style={styles.menuItem}>
          ...
          <View style={styles.groupDescription}>
              <Image style={styles.triangleImg} source={require("../assets/images/triangle.png")}></Image>
              <Text style={styles.menuDescription}>Strogonoff de frango</Text>
          </View>
        </View>
      </ScrollView>
